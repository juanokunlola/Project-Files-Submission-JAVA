 ...
 * Purpose: The TipsWindow.java class creates the GUI window for displaying three different recycling tips to educate the user. 
 * Originates: UserWindow (tipsButtton)
